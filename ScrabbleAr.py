...
easy_config = Config.Settings('easy')
medium_config = Config.Settings('medium')
hard_config = Config.Settings('hard')
    ...
    if event == '-LOGIN-':
        ...
        try:
            if a != None:
                ...
                if usuario_valido:
                    window1.close()
                    SelectorNiveles.main(lista_jugadores_2, jugador, usuario, easy_config, medium_config, hard_config)
                else:
